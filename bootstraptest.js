...
//******************************************************************************
// Nu komen de 2 blokken met berekeningen.
//******************************************************************************
...
//laten zien met welke brandstofprijs we rekenen
    ...
    var result = ((parseFloat(tax2)) * (parseFloat(bijt) / 100) * (parseFloat(belschijf / 100)) / 12 + parseFloat(extr) + parseFloat(pvergl)).toFixed(2);
...
function priveberekening() {
    ...
    var outputVeld = document.getElementById('gasspr2').innerText = gasspr;
